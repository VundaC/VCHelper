...
{
    class ChatDelegator : UICollectionViewDelegateFlowLayout
    {
        public ChatViewLayout ItemsViewLayout { get; }
        public ChatViewController ViewController { get; }

        protected float PreviousHorizontalOffset, PreviousVerticalOffset;

        public ChatDelegator(ChatViewLayout itemsViewLayout, ChatViewController itemsViewController)
        {
            ...
            nint section)
        {
            ...
            return ViewController.GetInsetForSection(collectionView, section);
        }
